'''// Collision info file for model.mod
collinfo 0 {		// kosijnt
	id		boun
	code		none
	type	1
	radius	33.333336
	centre	19.000000 -14.000000 0.000000

	collinfo 17 {		// centnull
		id		carc
		code		none
		type	1
		radius	0.000000
	...
	collinfo 7 {		// headjnt
		...
		type	1
		radius	16.000000
		centre	0.000000 -14.000000 0.000000
		}
	}
...
collinfo 0 {		// kosijnt
	...
	code		s
	type	2
	platform	tekis/frog/frogcol.mod
	}
